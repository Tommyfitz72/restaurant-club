...
export const env = {
  ...
  enableIntelligenceIngestion: toBool(process.env.ENABLE_INTELLIGENCE_INGESTION, true),
  intelligenceIngestionMode: process.env.INTELLIGENCE_INGESTION_MODE || 'safe',
  intelligenceIngestionIntervalHours: Number(process.env.INTELLIGENCE_INGESTION_INTERVAL_HOURS || 24),
  intelligenceMinTagConfidence: Number(process.env.INTELLIGENCE_MIN_TAG_CONFIDENCE || 0.6),
